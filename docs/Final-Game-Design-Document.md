# 1. Design Document (GDD) Template: https://connect-prd-cdn.unity.com/20201215/83f3733d-3146-42de-8a69-f461d6662eb1/Game-Design-Document-Template.pdf

## Game Name:
Flour and Fury

## Genre:
Light strategy, cozy casual, competitive tournament, chance-based
...
# 9. Player Definitions/Properties:

##  Player 1/2:
PLayers are bakers competing for winner baking champion of the baking district
...
##  Roll Button
Available for each player’s turn, roll once a turn, 

##  Player Turn Display
(TextMeshPro) visible display of each player’s turn
...
number count display of ingredients
