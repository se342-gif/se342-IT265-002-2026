...
- [ ] Settle on visual layout for physical game board of prototype
- [ ] Narrow down on additional rules for gameplay 

#### Progress
- **What I accomplished**:
  - Summarize completed tasks or progress made.
    - discussed game idea overview with professor and students in large-class discussion, settling on the main basic mechanics. 
- **Challenges faced**:
  - Describe blockers, bugs, or issues encountered.
  -  Deciding on between two different games - a classic board game vs card game with similar game rules and mechanics, but different layout and varied rules and length (less components, more simple prototype for demonstrative purpose vs. more thought out and executed gameplay.)
- **Solutions**:
  - Detail how you addressed challenges or your thought process.
    -  Accepted feedback from professor and students with the game mechanics and layout, found myself narrowing down on the specific layout, componenets, rules(more or less, still a work in progress as of now - still requires some polishing and refining, etc.).
